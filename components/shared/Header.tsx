          ...
          <div className="container mx-auto px-4 flex items-center h-20 justify-between">
            ...
            <div className="flex-1 max-w-2xl mx-8">
              <div className="relative">
                ...
                />
                {isSearching ? (
                  <Loader2 className="absolute right-4 top-1/2 -translate-y-1/2 h-5 w-5 text-red-500 animate-spin" />
                ) : (
                  <Search
                    className="absolute right-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500 cursor-pointer hover:text-gray-700 transition-colors"
